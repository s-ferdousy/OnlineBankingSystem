 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">  <a class="nav-link" href="maccounts.php">Admin Accounts</a></li>
...
if (isset($_GET['del']) && !empty($_GET['del']))
{
  ...
  $array = $con->query("select * from login where type='accountant'");
  
 ?>
<div class="container">
<div class="card w-100 text-center shadowBlue">
  <div class="card-header">
    Admin Accounts <button class="btn btn-outline-success btn-sm float-right" data-toggle="modal" data-target="#exampleModal">Add New Account</button>
  </div>
  <div class="card-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">New Accountant</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="saveAccount" class="btn btn-primary">Confirm</button>
      </form>
      </div>
    </div>
  </div>
