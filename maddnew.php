 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item ">  <a class="nav-link" href="maccounts.php">Admin Accounts</a></li>
      <li class="nav-item active">  <a class="nav-link" href="maddnew.php">Add User</a></li>
  ...
  <div class="card-body bg-dark text-white">
    <table class="table">
      <tbody>
        ...
        <tr>
          <td colspan="4">
            <button type="submit" name="saveAccount" class="btn btn-primary btn-sm">Confirm</button>
            <button type="Reset" class="btn btn-secondary btn-sm">Clear</button></form>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">New Accountant Account</h5>
